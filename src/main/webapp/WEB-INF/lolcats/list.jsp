...
<p align="right"><a href="/lolcats/manage/add">Add New Cat</a></p>
...
<%
	...
	for (LOLCat cat : cats) {
		...
		<br><a href="/lolcats/manage/edit?id=<%=cat.getId() %>">Edit</a> 
		| <a href="/lolcats/manage/delete?id=<%=cat.getId() %>">Delete</a> 
		</div><p></p>
		<% 
	}
	if (cats.isEmpty()) {
		%><p>There are no LOLCats in the system yet.  How sad! Maybe you want to <a href="/lolcats/manage/add">Add a New One</a>!</p><%
	}
%>
